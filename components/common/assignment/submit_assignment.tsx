	...
	return (
		<div>
			<div className="flex justify-between">
				<div id="title" className="text-2xl py-5 flex flex-col">
					<p>{assignmentTitle}</p>
			...
			<div id="details" className="py-2">
				<button
					className="dropDownTrigger border border-gray-500 rounded flex gap-1 px-2 items-center"
					onClick={() => handle(!open)}
				>
			...
			<hr />
			<div id="uploadFile">
				<label className="mt-2" htmlFor="file_input">
					UPLOAD FILE
				</label>
				<Input
					role="file_input"
