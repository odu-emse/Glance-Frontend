			...
			<nav className="flex bg-royalblue stdcontainer-sharp justify-end">
				...
				>
					...
					<div
						...
						} pt-3 right-0.5 top-12 absolute border-2 border-black gap-3 items-end justify-end flex-col w-56 float-right mr-5`}
					>
						<figcaption className={'text-sm text-royalblue'}>
							{' '}
							View Profile{' '}
						</figcaption>
						<figcaption className={'text-sm text-royalblue'}>
