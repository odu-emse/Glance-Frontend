...
export const UserProfile = ({ user, isCurrentUser }: UserProfileProps) => {
	...
	return (
		<div>
			<h1 className="font-microgramma text-royalblue ml-6 mb-5">{user.firstname} {user.lastName}</h1>
			<div className="flex flex-col md:flex-row mt-3">
				<aside className="flex-none flex-col mr-8 mx-6">
					...
					<div className="flex flex-col items-start ml-8 justify-center">
						{!isEditMode ? (
							<>
							<Anchor path={''} className="uppercase m-2 font-bold font-montesrrat"> Plan of study</Anchor>
							<Anchor path={''} className="uppercase m-2 font-bold font-montesrrat">Watched Threads</Anchor>
							<Anchor path={''} className="uppercase m-2 font-bold font-montesrrat">Module Reviews</Anchor>
							<Anchor path={''} className="uppercase m-2 font-bold font-montesrrat">Connections</Anchor>
							</>
						) : (
							<>
							<Anchor path={''} className="uppercase m-2 font-bold">Privacy Settings</Anchor>
							<Anchor path={''} className="uppercase m-2 font-bold">Connection Settings</Anchor>
							<Anchor path={''} className="uppercase m-2 font-bold">Notification Settings</Anchor>
							</>
						)}
					</div>
					</aside>
				...
				<div className='mx-10'>
					...
					<div className="SocialMedia mb-3">
							...
							(
								<>
								<input type="text" placeholder="GITHUB:" className="w-full m-1"/>
								<input type="text" placeholder="TWITTER:" className="w-full m-1"/>
								<input type="text" placeholder="LINKEDIN:" className="w-full m-1"/>
								<input type="text" placeholder="FACEBOOK:" className="w-full m-1"/>
								<input type="text" placeholder="PORTFOLIO:" className="w-full m-1"/>
								</>
							)
							}
					...
					<div className="bio mb-3">
						...
						{!isEditMode ? (
							<div>
								<p className='m-0 font-lora'>Joel DeSante is a senior at Old Dominion University, studying Game Design ... </p>
							</div>
						):
						(
							<textarea
