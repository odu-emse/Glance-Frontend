...
export const SidebarLessons = () => {
	...
	const lessons = ["Operations Research", "Supply Chain Management", "Linear Regression", "Nonlinear Algebra", "OR Quiz 1"];
	return (
		...
		>
			...
			
				{
					...
					<div className="font-montserrat text-blue mx-3 blue-800 flex text-base"><Anchor
