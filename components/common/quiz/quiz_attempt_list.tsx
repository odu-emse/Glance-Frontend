...
function QuizAttemptList({moduleId, instanceId, result} : {moduleId: string, instanceId: string, result: QuizResult}) {
	return (
		<div>
			...
			<QuizAttemptRow moduleId={moduleId} instanceId={instanceId} result={result} />
		</div>
	);
}
