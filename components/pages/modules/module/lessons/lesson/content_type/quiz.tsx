  ...
  return (
    ...
    <div className="flex flex-col w-full">
      ...
      <p>
        ...
        dolore autem? Alias quidem id a quia est maxime laborum error laboriosam
        odio excepturi consequuntur distinctio quae vero, ratione molestias.{" "}
      </p>
      {quizResponse ? (
        <>
          {quizResponse.quizInstance[0].questions.map((question, index) => (
            <QuizQuestion
              key={index}
        ...
        <div className="mt-12 container flex justify-center items-center h-full w-full">
          <Button onClick={() => takeQuizFunction()}>Take Quiz</Button>
          <p>{instanceId}</p>
        </div>
      )}
    </div>
