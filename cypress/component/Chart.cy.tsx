...
import { RadarComponent, RadarProps } from '../../storybook/components/Chart/Radar'


const { Simple, SingleChildrenRadar, MultipleChildrenRadar } = composeStories(stories)
...
describe('Line Chart', function () {
    ...
    it('should render component1', () => {
        cy.mount(<Simple legend={true}>
            <div className="h-96" id="w-full">
                <LineComponent
                    ...
                    width={100}
                    height={100} xaxisValues={[]} data1={[]}                />
            </div>
        </Simple>)
        expect(cy.get('div')).to.exist
        cy.get('div').should('exist')
        cy.get('div').children('div.recharts-responsive-container').should('exist')
        cy.get('div').children('div.recharts-responsive-container').should('be.visible')
        ...
        it('should respect panel width with charts', () => {
            cy.mount(<Simple legend={true} size={2}>
                <div className="h-64" id="test-id">
                    <PieComponent
                        data={[
                            { name: "January", graph1: 120,graph2: 200, },
