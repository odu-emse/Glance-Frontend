				...
				<ErrorStateWithDescription
					description={
						<span className="text-blue-500">
							...
							elit. Consequatur dignissimos dolor eaque eius
							eveniet harum incidunt, inventore natus omnis
							quaerat quas quibusdam quis sint tempore ullam
