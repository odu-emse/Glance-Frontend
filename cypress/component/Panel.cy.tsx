...
describe('Panel.tsx', function () {
			...
			cy.mount(
				<Text title={title}>
					<div id="test-id">
						...
						elit. Adipisci animi, ipsa laboriosam natus obcaecati
						odit quod voluptatibus! Beatae deleniti deserunt
	...
	describe('List', function () {
		...
		it('should render strings of the pass-in children of unordered list object and show their li css properties', () => {
			...
			cy.get('@child')
				.children('li')
				.should('have.text', 'SomeThingsAreBetterThenOthers')
			cy.get('@child')
				.children('li')
