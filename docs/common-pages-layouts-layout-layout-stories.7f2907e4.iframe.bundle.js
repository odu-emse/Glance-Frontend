;(self.webpackChunkglance = self.webpackChunkglance || []).push([
	[6030],
	{
		...
		'./components/common/pages/layouts/layout/layout.stories.tsx': (
			...
			const global_loading_context = (0, react.createContext)({
				isLoading: !0,
				setLoading: function setLoading(isLoading) {},
			})
			var _templateObject,
				loader = __webpack_require__('./components/util/loader.tsx'),
				...
				Logo = function Logo(_ref) {
					...
					return __jsx(
						...
						__jsx(
							'defs',
							null,
							__jsx('style', null, '.cls-1{fill:#fff;}'),
						),
						__jsx(
							'g',
							{ id: 'Layer_2-2' },
			...
			try {
				;(Logo.displayName = 'Logo'),
					...
					'undefined' != typeof STORYBOOK_REACT_CLASSES &&
						(STORYBOOK_REACT_CLASSES[
							'components/common/svg/logo.tsx#Logo'
						] = {
							docgenInfo: Logo.__docgenInfo,
							name: 'Logo',
							path: 'components/common/svg/logo.tsx#Logo',
						})
			} catch (__react_docgen_typescript_loader_error) {}
			var layout_jsx = react.createElement,
				Layout = function Layout(_ref) {
					var children = _ref.children,
						...
						_useState2 = (0, react.useState)(!0),
						open = _useState2[0],
						setOpen = _useState2[1],
						_useState3 = (0, react.useState)(!1),
						isAccountVisible = _useState3[0],
						setAccountVisible = _useState3[1],
						_useSession = (0, next_auth_react.useSession)(),
						session = _useSession.data,
						status = _useSession.status,
						setUser = (0, react.useContext)(
					...
					return 'loading' === status
						? layout_jsx(
								...
								{
									className:
										'flex justify-center items-center stdcontainer h-screen',
								},
								layout_jsx(loader.Z, {
									textColor: 'royalblue',
								}),
						...
						: ('undefined' == typeof window ||
								session ||
								router.push('/', '/', { shallow: !0 }),
						  data
								? layout_jsx(
										'section',
										{ className: 'h-screen' },
										layout_jsx(
											global_user_context.Z.Provider,
											{
												value: {
											...
											layout_jsx(
												...
												{
													className:
														'flex bg-royalblue stdcontainer-sharp justify-between h-16',
												},
												layout_jsx(
													'div',
													{
											...
											layout_jsx(
												...
												layout_jsx(
													...
													{
														className:
															'flex-1 grow overflow-y-auto',
													},
													layout_jsx(
														global_loading_context.Provider,
														{
															value: {
																isLoading,
																setLoading,
														...
														!0 === isLoading &&
															layout_jsx(
																...
																{
																	className:
																		'flex justify-center items-center stdcontainer h-32',
																},
																layout_jsx(
																	loader.Z,
																	{
			...
			try {
				;(Layout.displayName = 'Layout'),
					...
					'undefined' != typeof STORYBOOK_REACT_CLASSES &&
						(STORYBOOK_REACT_CLASSES[
							'components/common/pages/layouts/layout/layout.tsx#Layout'
						] = {
							docgenInfo: Layout.__docgenInfo,
							name: 'Layout',
							path: 'components/common/pages/layouts/layout/layout.tsx#Layout',
						})
			} catch (__react_docgen_typescript_loader_error) {}
			var _Primary$parameters,
				_Primary$parameters2,
				_Primary$parameters2$,
				content_jsx = react.createElement,
				Content = function Content(_ref) {
					...
					return content_jsx(
						...
						{
							className:
								'bg-gray-50 min-h-screen shadow rounded-md flex flex-col w-full p-2',
						},
						children,
					)
				}
			...
			try {
				;(Content.displayName = 'Content'),
					...
					'undefined' != typeof STORYBOOK_REACT_CLASSES &&
						(STORYBOOK_REACT_CLASSES[
							'components/common/pages/content/content.tsx#Content'
						] = {
							docgenInfo: Content.__docgenInfo,
							name: 'Content',
							path: 'components/common/pages/content/content.tsx#Content',
						})
			} catch (__react_docgen_typescript_loader_error) {}
			var layout_stories_jsx = react.createElement
			...
			var Template = function Template(args) {
				return layout_stories_jsx(
					next_auth_react.SessionProvider,
					null,
					layout_stories_jsx(
						Layout,
						null,
						layout_stories_jsx(sidebar.Y, {
							isLoading: !1,
							userSession: null,
							icon: null,
						...
						layout_stories_jsx(
							...
							layout_stories_jsx(
								...
								{
									className:
										'border-blue-300 border-dashed border-4',
								},
								'Hello World',
							),
							layout_stories_jsx(
								'p',
								null,
								'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Optio, ad. Quam molestiae porro unde illo, odit vero perspiciatis, saepe quos delectus totam esse harum nemo itaque blanditiis consequuntur placeat laboriosam!',
							),
							layout_stories_jsx(
								'p',
								null,
