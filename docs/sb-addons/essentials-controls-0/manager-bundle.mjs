try {
	...
	var yl = F((Mq, gl) => {
		...
		function eE(e, t, r, n, a, o, i) {
			switch (r) {
				...
				case QA:
					return !(
						e.byteLength != t.byteLength || !o(new hl(e), new hl(t))
					)
				case zA:
				case HA:
				case VA:
		...
		var Yv = Wc(),
			...
			Qv = Yv(function (e) {
				...
				return (
					...
					e.replace(Jv, function (r, n, a, o) {
						t.push(a ? o.replace(Xv, '$1') : n || r)
					}),
					t
				)
			})
	...
	var qr = F((hd, Uo) => {
		...
		;(function (e) {
			...
			return (function n(a, o, i) {
				...
				for (
					var s = typeof yr == 'function' && yr, d = 0;
					d < i.length;
					d++
				)
					u(i[d])
	...
	var Wd = F(($r, Jt) => {
		...
		var LS = ze(),
			...
			Ud = Gd && typeof Jt == 'object' && Jt && !Jt.nodeType && Jt,
			$S = Ud && Ud.exports === Gd,
	...
	var qn = F((xY, j0) => {
		...
		ie.prototype = {
			then: function (e, t) {
				...
				if (this._isResolved())
					return ie.resolve(this._data)._setParent(this)
	...
	var Ln = F((NY, q0) => {
		...
		function DB(e) {
			...
			return typeof r == 'function' && r instanceof r && M0.call(r) == EB
		}
		q0.exports = DB
	})
	var $0 = F((LY, L0) => {
	...
	var rh = F((_J, th) => {
		...
		th.exports = function (t) {
			var r = this
			if (typeof r != 'function' || zB.call(r) !== HB)
	...
	var Wn = F((UJ, ch) => {
		...
		var Jo = function () {
			...
			Ot = {
				...
				'%isFinite%': isFinite,
				'%isNaN%': isNaN,
				'%IteratorPrototype%': er ? Je(Je([][Symbol.iterator]())) : ne,
		...
		try {
			...
			;(ih = Je(Je(e))), (Ot['%Error.prototype%'] = ih)
		}
		var ih,
			YB = function e(t) {
				var r
			...
			tT = function (t) {
				...
				var a = []
				return (
					sh(t, ZB, function (o, i, u, s) {
						a[a.length] = u ? sh(s, eT, '$1') : i || o
					}),
					a
				)
			},
			rT = function (t, r) {
				var n = t,
					a
				if (
					(Hn(uh, n) && ((a = uh[n]), (n = '%' + a[0] + '%')),
					Hn(Ot, n))
				) {
					var o = Ot[n]
					if ((o === tr && (o = YB(n)), typeof o > 'u' && !r))
						throw new rr(
							'intrinsic ' +
								t +
	...
	var gh = F((WJ, Vn) => {
		...
		var Xo = zn(),
			...
			mh = ar('%Reflect.apply%', !0) || Xo.call(hh, fh),
		...
		Vn.exports = function (t) {
			var r = mh(Xo, hh, arguments)
			if (ph && Rt) {
				var n = ph(r, 'length')
				n.configurable &&
					Rt(r, 'length', {
						value: 1 + nT(0, t.length - (arguments.length - 1)),
					})
			}
			return r
		}
		var dh = function () {
			return mh(Xo, fh, arguments)
		}
	...
	var Eh = F((JJ, Ah) => {
		...
		Ah.exports = function (t, r) {
			var n = yh(t, !!r)
			return typeof n == 'function' && aT(t, '.prototype.') > -1
				? bh(n)
				: n
		}
	})
	...
	var $h = F((oX, Lh) => {
		...
		var ui = typeof Map == 'function' && Map.prototype,
			...
			Wr = oT ? WeakMap.prototype.has : null,
			iT = typeof WeakSet == 'function' && WeakSet.prototype,
			Vr = iT ? WeakSet.prototype.has : null,
			uT = typeof WeakRef == 'function' && WeakRef.prototype,
			xh = uT ? WeakRef.prototype.deref : null,
		...
		Lh.exports = function e(t, r, n, a) {
			...
			if (ST(t)) {
				...
				return (
					...
					Ph('Set', Jn.call(t), M, A)
				)
			}
			if (xT(t)) return ti('WeakMap')
			if (wT(t)) return ti('WeakSet')
			if (FT(t)) return ti('WeakRef')
			if (bT(t)) return Gr(g(Number(t)))
			if (ET(t)) return Gr(g(ri.call(t)))
			if (AT(t)) return Gr(sT.call(t))
			if (yT(t)) return Gr(g(String(t)))
			if (!mT(t) && !Rh(t)) {
				var I = Kn(t, g),
					U = Bh
		...
		function qh(e, t) {
			...
			var a = bt.call(bt.call(e, /(['\\])/g, '\\$1'), /[\x00-\x1f]/g, TT)
...
` +
	...
	var zh = F((lX, Uh) => {
		...
		var ci = Wn(),
			...
			Xn = ci('%WeakMap%', !0),
			Qn = ci('%Map%', !0),
			IT = ir('WeakMap.prototype.get', !0),
			kT = ir('WeakMap.prototype.set', !0),
			NT = ir('WeakMap.prototype.has', !0),
			jT = ir('Map.prototype.get', !0),
			MT = ir('Map.prototype.set', !0),
			qT = ir('Map.prototype.has', !0),
			pi = function (e, t) {
			...
			var t,
				...
				a = {
					assert: function (o) {
						if (!a.has(o))
							throw new PT(
								'Side channel does not contain ' + RT(o)
							)
					},
					get: function (o) {
						if (
	...
	var Qh = F((DX, Xh) => {
		...
		var Yh = zh(),
			...
			mi = {},
			i8 = function e(t, r, n, a, o, i, u, s, d, y, A, g, m, E, b, x) {
				for (
					var S = t, P = x, j = 0, $ = !1;
					(P = P.get(mi)) !== void 0 && !$;
			...
			u8 = function (t) {
				...
				if (typeof t.format < 'u') {
					if (!r8.call(Kr.formatters, t.format))
				...
				var a = Kr.formatters[n],
					o = Pe.filter
				return (
					(typeof t.filter == 'function' || st(t.filter)) &&
						(o = t.filter),
					{
						addQueryPrefix:
						...
						delimiter:
							typeof t.delimiter > 'u'
								...
								: t.delimiter,
						encode:
							typeof t.encode == 'boolean' ? t.encode : Pe.encode,
						encoder:
							typeof t.encoder == 'function'
								? t.encoder
								: Pe.encoder,
	...
	var tm = F((FX, em) => {
		...
		var ur = hi(),
			...
			m8 = function (t) {
				...
				return {
					allowDots:
						typeof t.allowDots > 'u' ? Te.allowDots : !!t.allowDots,
					allowPrototypes:
					...
					decoder:
						typeof t.decoder == 'function' ? t.decoder : Te.decoder,
					delimiter:
						typeof t.delimiter == 'string' ||
						ur.isRegExp(t.delimiter)
							? t.delimiter
							: Te.delimiter,
					depth:
	...
	var sr = F((TX, rm) => {
		...
		var g8 = Qh(),
			y8 = tm(),
			b8 = Zn()
		rm.exports = { formats: b8, parse: y8, stringify: g8 }
	})
	var _m = F((tee, Tm) => {
		l()
		c()
				...
				for (k = B === 'u' ? 4 : 2, R = 0; R < k; ++R)
					if (a < n && s.code.isHexDigit(r.charCodeAt(a)))
						(_ = b()),
							(L =
								L * 16 +
								'0123456789abcdef'.indexOf(_.toLowerCase()))
					else return ''
			...
			function S() {
				...
				for (R = r.charAt(a), ++a; a < n; )
					if (((k = b()), k === R)) {
						...
						if (
							((k = b()),
							s.code.isLineTerminator(k.charCodeAt(0)))
						)
...
`
				...
				return (
					R !== '' && d.throwError('unexpected quote'),
					(u = B),
					t.STRING
				)
			}
			function P() {
				...
				if (((B = ''), (R = r.charCodeAt(a)), R !== 46)) {
					if (((B = b()), (R = r.charCodeAt(a)), B === '0')) {
						if (R === 120 || R === 88) {
							for (
								B += b();
								a < n &&
								((R = r.charCodeAt(a)), !!s.code.isHexDigit(R));
					...
					for (
						;
						a < n &&
						((R = r.charCodeAt(a)), !!s.code.isDecimalDigit(R));
			...
			function U() {
				...
				for (
					...
					if (i === t.REST) {
						;(k = a - 3),
							w(t.REST),
							B.push(
								E({ type: e.RestType, expression: Y() }, [k, o])
							)
						break
					} else B.push(Y())
				...
				return (
					M(t.RBRACK), E({ type: e.ArrayType, elements: B }, [R, o])
				)
			}
			function K() {
				var B = u
			...
			function z() {
				...
				return (
					...
					i === t.COLON
						? (w(t.COLON),
						  E({ type: e.FieldType, key: B, value: Y() }, [R, o]))
			...
			function he() {
				...
				if (
					...
					for (; i !== t.RBRACE; )
						B.push(z()), i !== t.RBRACE && M(t.COMMA)
				return (
					(k = a),
					M(t.RBRACE),
					E({ type: e.RecordType, fields: B }, [R, k])
				)
			}
			function re() {
				var B = u,
			...
			function q() {
				for (
					...
					i === t.REST && (w(t.REST), (_ = !0)),
						...
						i === t.EQUAL
							? (w(t.EQUAL),
							  (k = E({ type: e.OptionalType, expression: k }, [
									L,
									o,
							  ])),
							  (R = !0))
						...
						_ &&
							(k = E({ type: e.RestType, expression: k }, [
								H,
								o,
							])),
						B.push(k),
			...
			function W() {
				...
				return (
					...
					(_ = null),
					i === t.COLON && (_ = T()),
					(L = E({ type: e.FunctionType, params: k, result: _ }, [
						H,
						o,
					])),
			...
			function me() {
				...
				return i === t.REST
					? (w(t.REST),
					  E({ type: e.RestType, expression: te() }, [0, a]))
					: ((B = te()),
					  i === t.EQUAL
							? (w(t.EQUAL),
							  E({ type: e.OptionalType, expression: B }, [
									0,
									a,
							  ]))
							: B)
...
\u2028\u2029])`
			...
			;(function (w) {
				...
				function J(k, _, L) {
					...
					if (Be) return null
					for (Ee = 1, pe = ''; I < _; )
						if (((H = z.charCodeAt(I)), n.code.isLineTerminator(H)))
							T()
						else {
							if (H === 125) {
								if (((Ee -= 1), Ee === 0)) {
				...
				function Y(k) {
					...
					for (
						_ = T();
						I < k && n.code.isIdentifierPartES5(z.charCodeAt(I));
				...
				;(Q.prototype.addError = function (_) {
						...
						return (
							Ee >= 0 && pe >= 0
								? ((this._tag.caption = _.substring(
								  ...
								  (this._tag.description = _.substring(
										pe + H.length
								  ).trim()))
								: (this._tag.description = _),
							!0
					...
					(Q.prototype.parseKind = function () {
						...
						return (
							...
							!(
								!a(L, _) &&
								!this.addError("Invalid kind name '%0'", _)
							)
						)
					}),
					...
					(Q.prototype.parseVariation = function () {
						...
						return (
							...
							!(
								isNaN(_) &&
								!this.addError("Invalid variation '%0'", L)
							)
						)
					}),
				...
				function He(k) {
					var _, L, H
					if (!je()) return null
					for (_ = q(), L = new Q(k, _), H = L.parse(); I < L._last; )
						T()
					return H
				}
				function B(k) {
				...
				function R(k, _) {
					...
					if (
						(_ === void 0 && (_ = {}),
						typeof _.unwrap == 'boolean' && _.unwrap
							? (z = j(k))
							: (z = k),
						(he = k),
						_.tags)
		...
		rg = tt(() => {
			...
			;(fr = function (e, t, r) {
				...
				(Lm = function (e, t, r) {
					...
					return {
						left: fr(
							(a.pageX - (n.left + Ti(e).pageXOffset)) / n.width
						),
						top: fr(
							(a.pageY - (n.top + Ti(e).pageYOffset)) / n.height
						),
					}
				}),
				($m = function (e) {
				...
				(HO = function (e, t) {
					return (
						e.toLowerCase() === t.toLowerCase() || Km(_i(e), _i(t))
					)
				})
			;(WO = typeof window < 'u' ? du : oe),
				...
				(eg = function (e) {
					return h.createElement(Zm, It({}, e, { colorModel: XO }))
				}),
				(QO = {
	...
	function M2(e, t) {
		...
		var r = pt(t)
		return dt(
			Oe({}, r, { lightness: qt(0, 1, r.lightness - parseFloat(e)) })
		)
	}
	var q2 = qe(M2),
		Ue = q2
	...
	function G2(e, t) {
		...
		var r = Mt(t),
			...
			a = Oe({}, r, {
				alpha: qt(0, 1, (n * 100 + parseFloat(e) * 100) / 100),
			})
		return We(a)
	}
	var W2 = qe(G2),
				...
				(e.isEqual = (function () {
					...
					return function (a, o) {
						return (function i(u, s, d) {
							...
							if (d.indexOf(u) > -1 && d.indexOf(s) > -1)
								return !0
							if (
								(d.push(u, s),
								m != E ||
...
`
	...
	var KF = /^\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/,
		YF = /^!\[([^\]]*)]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/,
		fd = [Jp, Xp, Qp, Zp, ed, td, rd, sd, pd, ld, dd],
		JF = [...fd, /^[^\n]+(?:  \n|\n{2,})/, Mo, qo]
	function XF(e) {
		return e
		...
		function n(m, E, ...b) {
			...
			return r(
				(function (S, P) {
					...
					return j
						? typeof j == 'function' ||
						  (typeof j == 'object' && 'render' in j)
							? j
							: jo(P, `${S}.component`, S)
						: S
				})(m, t.overrides),
				wt({}, E, x, {
					className: nS(E?.className, x.className) || void 0,
				}),
				...b
			)
		}
...
`,
			...
			for (
				;
				typeof b[b.length - 1] == 'string' && !b[b.length - 1].trim();
		...
		t.disableParsingRawHTML !== !0 &&
			((s.htmlBlock = {
				...
				l(m, E, b) {
					...
					let I = M ? m[3] : j(E, P, b)
					return (
						(b.Z = !1), { I: o(m[2]), $: I, G: M, H: M ? w : m[1] }
					)
				},
				h: (m, E, b) =>
					n(m.H, wt({ key: b.k }, m.I), m.G ? m.$ : E(m.$, b)),
			}),
			(s.htmlSelfClosing = {
				t: Mr(qo),
				i: ae.HIGH,
...
`
	...
	var GV = __STORYBOOKCOREEVENTS__,
		{
			...
			NAVIGATE_URL: Uf,
			PLAY_FUNCTION_THREW_EXCEPTION: Z5,
			PRELOAD_ENTRIES: e3,
	...
	var y3 = Object.create,
		...
		Ye = (e, t) =>
			function () {
				return (
					t || (0, e[Vf(e)[0]])((t = { exports: {} }).exports, t),
					t.exports
				)
			},
		D3 = (e, t, r, n) => {
	...
	function C3() {
		return ee[Go] || (ee[Go] = new v3()), ee[Go]
	}
	var jn = C3()
	var RB = se(qr(), 1),
		PB = se(Bt(), 1),
...
`,
	...
	var U0 = (e, t) => (Array.isArray(t) ? t.includes(e) : e.match(t)),
		...
		Y0 = (e) => {
			...
			if (!r) return t
			let i = Tt(t, n, a),
				u = (0, V0.default)(i, (s, d) => s?.type && LB(s, d, o))
			return Zt(u, i)
		}
	Y0.secondPass = !0
	var D8 = se(qn(), 1)
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)
				...
				function he(O, T, q) {
					...
					function B(fe, Be) {
						;(Be > J && W) ||
							((W = !1), (O = O.replace(fe.pattern, fe.sub)))
					}
					var R = [],
						k = O,
						_ = k.length
			...
			'node_modules/get-intrinsic/index.js'(e, t) {
				...
				var r,
					...
					i = function (re) {
						try {
							return a(
								'"use strict"; return (' + re + ').constructor;'
							)()
						} catch {}
					},
				...
				t.exports = function (g) {
					...
					if (u && s) {
						...
						E.configurable &&
							s(m, 'length', {
								value:
									1 + d(0, g.length - (arguments.length - 1)),
							})
					}
					return m
				}
	...
	function y6(e) {
		var t = this.__data__
		return Jr ? t[e] !== void 0 : g6.call(t, e)
	}
	var b6 = y6,
...
` &&
	...
	var ma = (e) => ({
		...
		sR = (e) => {
			...
			return h.createElement(
				...
				t
					? h.createElement(iR, { ...e })
					: h.createElement(uR, { ...e })
			)
		},
	...
	var fR = N(tR)({
		...
		Xg = ({ text: e, simple: t }) => h.createElement(AR, { simple: t }, e),
		...
		kg = (e, t = !0) => {
			...
			return (
				t || (r = e.slice(0, Wi)),
				r.map((n) =>
					h.createElement(Xg, { key: n, text: n === '' ? '""' : n })
				)
			)
		},
		wR = ({ value: e, initialExpandedArgs: t }) => {
			...
			if (n == null) {
				if (/[(){}[\]<>]/.test(s))
					return h.createElement(Xg, { text: s })
				let d = SR(s),
					y = d.length
				return y > Wi
					? h.createElement(
				...
				E = de(
					(S) => {
						...
						Number.isNaN(P)
							? m(
									new Error(
										`'${S.target.value}' is not a number`
									)
							  )
							: (r(P), m(null))
					},
			...
			return h.createElement(
				...
				i
					...
					: h.createElement(ly, {
							...
							plusMenuElement: h.createElement(Lg, {
								icon: 'add',
							}),
							minusMenuElement: h.createElement(Lg, {
								icon: 'subtract',
							}),
	...
	var O9 = ({ onChange: e, name: t, accept: r = 'image/*', value: n }) => {
		...
		fa = (e) => {
			...
			return h.createElement(
				...
				r
					? h.createElement('td', null, h.createElement(k9, { ...e }))
					: null
			)
		},
		U9 = N(Fe)(({ theme: e }) => ({
			...
			return h.createElement(
				...
				h.createElement(
					...
					h.createElement(
						...
						h.createElement(
							Hg,
							{ onClick: (g) => i(!o), tabIndex: 0 },
							A
						),
						h.createElement(
							z9,
							null,
							h.createElement(U9, { icon: y }),
							t
						)
					),
					h.createElement(
		...
		J9 = N.span({ display: 'flex', justifyContent: 'space-between' }),
		X9 = {
		...
		Rne = N.div(ct, ({ theme: e }) => ({
			...ma(e),
			margin: '25px 0 40px',
			padding: '30px 20px',
		}))
	var jne = N.div(({ theme: e }) => ({
			fontWeight: e.typography.weight.bold,
			color: e.color.defaultText,
		})),
		Mne = N.div(({ theme: e }) => ({
		...
		qne = N.div({ flex: '0 0 30%', lineHeight: '20px', marginTop: 5 }),
		Lne = N.div(({ theme: e }) => ({
			flex: 1,
			textAlign: 'center',
			fontFamily: e.typography.fonts.mono,
		...
		$ne = N.div({ display: 'flex', flexDirection: 'row' }),
		Une = N.div(({ background: e }) => ({
			position: 'relative',
			flex: 1,
			'&::before': {
				position: 'absolute',
		...
		Gne = N.div({ flex: 1, display: 'flex', flexDirection: 'row' }),
		Wne = N.div({ display: 'flex', alignItems: 'flex-start' }),
		Vne = N.div({ flex: '0 0 30%' }),
		Kne = N.div({ flex: 1 }),
		Yne = N.div(({ theme: e }) => ({
			display: 'flex',
			flexDirection: 'row',
	...
	var eae = N.div(({ theme: e }) => ({
		...
		nae = N.div({ display: 'flex', flexFlow: 'row wrap' })
	var rP = (e) => `anchor--${e}`,
	...
	var oP = (e, t) => {
			...
			let o = de(
				...
				i = de(
					(u) => t.channel.emit(Xt, { storyId: e, argNames: u }),
					[e]
				)
			return [n, o, i]
		},
				...
				(d = o.map((E, b) => {
					...
					return (
						b === 0 &&
							(y =
								j.format ??
								E.parameters.docs?.source?.format ??
								!1),
						bP({
							snippet: j.code,
		...
		DP = (
			...
			let u = br
					...
					.filter(
						(g) =>
							g.props &&
							(g.props.id || g.props.name || g.props.of)
					)
					.map((g) => by(g.props, o)),
				s = au(u, o),
				d = s.some((g) => !g),
			...
			return (
				...
				s.forEach((g) => {
					A ||
						...
						(A =
							g?.parameters.layout ??
							g.parameters.docs?.canvas?.layout)
				}),
				{
					isLoading: d,
					previewProps: {
  ...
  `),
	...
	var Ji = Na.a,
		...
		FP = (e) => {
			...
			if (t) {
				if (t.startsWith('#'))
					return h.createElement(xP, { hash: t }, n)
      ...
      `)
		...
		RP = (e) =>
			e && (typeof e == 'string' ? e : oa(e.markdown) || oa(e.text)),
		...
		NP = ({ type: e, markdown: t, children: r }, { storyById: n }) => {
			...
			let { extractComponentDescription: d = IP, description: y } =
					s || {},
				A = y?.component
			if (A) return A
			switch (e) {
