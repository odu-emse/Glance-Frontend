...
`,
	...
	function T(e) {
		...
		var f = ge.exec(t.substring(0, 50))
		if (f) {
			var j = parseInt('' + f[1], 10),
	...
	function $(e, t, r) {
		if (
			...
			return H('#' + g(e) + g(t) + g(r))
		if (typeof e == 'object' && t === void 0 && r === void 0)
			return H('#' + g(e.red) + g(e.green) + g(e.blue))
		throw new u(6)
	}
	function w(e, t, r, a) {
	...
	function ke(e, t) {
		...
		var r = J(t)
		return Q(v({}, r, { lightness: _(0, 1, r.lightness - parseFloat(e)) }))
	}
	var Oe = I(ke),
		Te = Oe
	function Ie(e, t) {
	...
	function Be(e, t) {
		...
		var r = T(t),
			...
			n = v({}, r, {
				alpha: _(0, 1, (a * 100 + parseFloat(e) * 100) / 100),
			})
		return w(n)
	}
	var Gt = I(Be)
	...
	var V = G({
		...
		brandImage:
			'https://raw.githubusercontent.com/odu-emse/Glance-Frontend/dfcceb573bbd40592e48d87f660489c66866838f/public/images/GLANCE_1.png',
		brandTarget: '_self',
	})
	N.setConfig({ theme: V })
} catch (e) {
