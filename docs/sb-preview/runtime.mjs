...
var require_memoize = __commonJS({
	'../../node_modules/lodash/memoize.js'(exports, module) {
		...
		function memoize4(func, resolver) {
			...
			return (
				(memoized.cache = new (memoize4.Cache || MapCache2)()), memoized
			)
		}
		...
		prepareContext = (context) => {
			...
			let mappedArgs = Object.entries(finalContext.args).reduce(
					(acc, [key2, val]) => {
						...
						return (
							(acc[key2] =
								mapping && val in mapping ? mapping[val] : val),
							acc
						)
					},
					{}
				...
				includedArgs = Object.entries(mappedArgs).reduce(
					(acc, [key2, val]) => {
						...
						return (
							v(argType, mappedArgs, finalContext.globals) &&
								(acc[key2] = val),
							acc
						)
					},
...
var inferType = (value2, name2, visited) => {
      ...
      `),
				...
				: (visited.add(value2),
				  Array.isArray(value2)
						...
						: {
								name: 'object',
								value: (0, import_mapValues3.default)(
									value2,
									(field) =>
										inferType(
											field,
	...
	inferArgTypes = (context) => {
		let { id, argTypes: userArgTypes = {}, initialArgs = {} } = context,
			argTypes = (0, import_mapValues3.default)(
				initialArgs,
				(arg, key2) => ({
					name: key2,
