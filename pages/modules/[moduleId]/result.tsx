...
function QuizResultPage() {
	...
	if(error) return <RequestFailed title={"Result not found"} subtitle={error.message} />
	...
	return (
		<section className="stdcontainer">
			...
			<QuizAttemptList result={result} moduleId={moduleId as string} instanceId={instanceId as string} />
		</section>
	);
}
