		...
		<div className='h-auto mx-auto relative bg-[#E7E8E9] overflow-hidden'>
			<div className='flex flex-1'>
			  ...
			  ></textarea>
				...
				<div
					className='hidden md:flex md:container md:ml-36 md:relative md:w-11/12 bg-white shadow-lg h-screen overflow-y-auto'>
					<div className='flex flex-col h-full w-full '>
						<div
							className='px-3 h-20 flex shrink-0 w-full items-center justify-center border-b border-gray-150'>
							<Input
