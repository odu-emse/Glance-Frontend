    ...
    return (
        <div className="grid grid-cols-1 divide-y">
            <div className="border-b p-2 bg-white ">
                <div className="flex items-center justify-between ">
                    <div className="flex space-x-3 md:space-x-3">
                        <button type="button" className="py-2.5 px-5 mr-2 mb-2 text-xs font-medium text-gray-600 focus:outline-none bg-transparent rounded-full border-2 border-blue-300 hover:bg-gray-100 hover:text-gray-600 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">{message[0].messages}</button>
                        <button type="button" className="py-2.5 px-5 mr-2 mb-2 text-xs font-medium text-gray-600 focus:outline-none bg-transparent rounded-full border-2 border-blue-300 hover:bg-gray-100 hover:text-gray-600 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">{message[1].messages}</button>
                        <button type="button" className="py-2.5 px-5 mr-2 mb-2 text-xs font-medium text-gray-600 focus:outline-none bg-transparent rounded-full border-2 border-blue-300 hover:bg-gray-100 hover:text-gray-600 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">{message[2].messages}</button>

                    </div>
                </div>
            </div>

            <div className="flex justify-between items-center my-2 text-stone-900 w-full shadow-lg">



                <div className="flex gap-2">
                    <button className="flex items-center justify-center px-8" onClick={() => setIsClicked(!isClicked)}>
          ...
          " />
                    ...
                    <button className="flex items-center justify-center px-8 " onClick={() => setIsClicked1(!isClicked1)}>
          ...
          " />
                    ...
                    <button className="flex items-center justify-center px-8 " onClick={() => setIsClicked2(!isClicked2)} >
