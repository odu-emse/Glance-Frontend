...
import SidebarForModulesStories from '../../stories/SidebarForModules.stories'

export const SidebarForModules = ({
	topics
} :SidebarForModulesProps) =>{
	return(	
<aside className="w-80" aria-label="Sidebar">
   <div className="overflow-y-auto bg-gray-200 rounded dark:bg-gray-800">
	...
	<div className="flex justify-between">
  		<span className="text-sm font-normal text-gray-50 mt-2 mb-1">MODULE PROGRESS - 75%</span>
	</div>
