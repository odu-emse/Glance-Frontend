...
isCurrentUser,
   ...
   // const [user, setUser] = useState(null) 
    ...
    //const [isClicked, setIsClicked] = React.useState(user.clicked ?? false)
...
Profile Details                </li>
    ...
    <div className="w-full md:w-3/4">
        ...
        <form>
            ...
            <Button label='Update Profile' type="submit"  disabled={!isCurrentUser} primary />
...
{showPlanOfStudy &&(
  ...
  <thead>
    <tr>
      ...
      <th className="border border-slate-300 ...">Term</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td className="border border-slate-300 ...">{user.planOfStudy[0].status}</td>
      <td className="border border-slate-300 ...">{user.planOfStudy[0].term}</td>
    </tr>
    <tr>
      <td className="border border-slate-300 ...">{user.planOfStudy[1].status}</td>
      <td className="border border-slate-300 ...">{user.planOfStudy[1].term}</td>
    </tr>
    <tr>
      <td className="border border-slate-300 ...">{user.planOfStudy[2].status}</td>
      <td className="border border-slate-300 ...">{user.planOfStudy[2].term}</td>
    </tr>
  </tbody>
</table>
</div>
